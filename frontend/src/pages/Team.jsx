...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      github: '#',
      linkedin: '#',
      email: 'sai@healthsync.com',
    },
    {
      name: 'Pranav',
      role: 'Project Manager',
      avatar: '👨‍💼',
      bio: 'Experienced project manager coordinating team efforts and ensuring project success.',
      skills: ['Agile', 'Scrum', 'Team Leadership', 'Project Planning'],
      github: '#',
      linkedin: '#',
      email: 'pranav@healthsync.com',
    },
    {
      name: 'Ritvik',
      role: 'UX Designer',
      avatar: '👨‍🎨',
      bio: 'Creative designer focused on user experience and visual design for health applications.',
      skills: ['Figma', 'Adobe XD', 'Prototyping', 'User Research'],
      github: '#',
      linkedin: '#',
      email: 'ritvik@healthsync.com',
    },
  ];
  ...
  const projectInfo = [
    {
      ...
      description:
        'HealthSync was built during an 8-hour hackathon, demonstrating rapid prototyping and innovation.',
    },
    {
      icon: Code,
